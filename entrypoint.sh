...
jupyter notebook /home/jovyan/demos/object_detection_demo/jupyter-python/object_detection_demo_nomo.ipynb --port ${port} --ip 0.0.0.0 --no-browser --TagRemovePreprocessor.remove_cell_tags={"hide",} 
