...
voila /home/jovyan/demos/object_detection_demo/jupyter-python/object_detection_demo_mo.ipynb --port=${port} --no-browser --TagRemovePreprocessor.remove_cell_tags={"hide",} --debug --Voila.base_url=${base_url}
